...
const SYNC_YOUTUBE_RATE_LIMIT_MAX = 10;
const SYNC_YOUTUBE_RATE_LIMIT_WINDOW_MS = 60_000;
...
exports.handler = async (event) => {
  ...
  const rl = rateLimit("sync-youtube:" + auth.user.id, SYNC_YOUTUBE_RATE_LIMIT_MAX, SYNC_YOUTUBE_RATE_LIMIT_WINDOW_MS);
