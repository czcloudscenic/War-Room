...
export const NAV = [
  { section:"COMMAND", items:[{ id:"dashboard", label:"Dashboard" }, { id:"taskboard", label:"Task Board" }, { id:"agents", label:"Agents" }, { id:"cid", label:"Competitor Intel" }, { id:"icp", label:"Ideal Customer" }]},
  { section:"CONTENT", items:[{ id:"instagram", label:"Instagram" }, { id:"tiktok", label:"TikTok" }, { id:"youtube", label:"YouTube" }, { id:"tracker", label:"Content Tracker" }, { id:"briefgen", label:"Brief → Content" }]},
